...
export default function Home() {
  ...
  const documents = useMemo(() => [
    { file: "/p1.pdf", label: "CONFIDENTIAL_A", level: "TOP SECRET", size: "2.4 MB", lastAccessed: "2024-01-15" },
    { file: "/p2.pdf", label: "CONFIDENTIAL_B", level: "CLASSIFIED", size: "1.8 MB", lastAccessed: "2024-01-14" },
    { file: "/p3.pdf", label: "CONFIDENTIAL_C", level: "RESTRICTED", size: "3.1 MB", lastAccessed: "2024-01-13" }
  ], []);
